...
public class GetTokenOperation implements ApiOperation {
	...
	public HttpRequestBase invoke(Uri endpoint, String token, String tenantId,
		...
		tenantId = params.getString("tenantId");
		
		GetTokenRequest request = new GetTokenRequest(new AuthObject(new PasswordCredentialsObject(params.getString("username"), params.getString("password")), params.getString(tenantId)));
